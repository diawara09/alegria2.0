    ...
    <>
      ...
      <div className="flex p-10 gap-20 lg:p-20 flex-col overflow-x-hidden">
        <div className="flex flex-wrap justify-between">
            ...
            <p className="flex-2 shrink-0 min-w-60">Découvrez l’équipe de bénévoles qui compose HEVA. Grâce à toutes ces personnes, 
                nous sommes en capacité de jouer un rôle important pour les populations.</p>
        </div>
